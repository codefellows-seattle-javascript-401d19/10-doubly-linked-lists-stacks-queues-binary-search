...
const LinkedList = require('../model/doubly-linked-list');
...
describe('linked-list.js', () => {
  ...
  test('insertion should properly modify the next|previous property', () => {
    let result = new LinkedList(5);
  ...
  test('remove should update the next|previous property and erase an element', () => {
